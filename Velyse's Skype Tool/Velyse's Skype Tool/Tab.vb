...
Public Class XylosTabControl
    ...
    Protected Overrides Sub OnControlAdded(e As ControlEventArgs)
        ...
        e.Control.BackColor = (Color.FromArgb(31, 31, 31))
        e.Control.ForeColor = Color.White
        e.Control.Font = New Font("Verdana", 8.5)
    End Sub
        ...
        For I As Integer = 0 To TabPages.Count - 1
            ...
            If String.IsNullOrEmpty(TabPages(I).Tag) Then
                ...
                If SelectedIndex = I Then
                    ...
                    Using Background As New SolidBrush(ColorFromHex("#1e90ff")), TextColor As New SolidBrush(ColorFromHex("#BECCD9")), TextFont As New Font("Segoe UI semibold", 9)
...
Public Class XylosCombobox
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Not IsNothing(Items) Then
            ...
            Using ItemsFont As New Font("Verdana", 8.5), ItemsColor As New SolidBrush(ColorFromHex("#FFFFFF"))
            ...
            Try
                ...
                Using ItemsFont As New Font("Segoe UI", 9), Border As New Pen(ColorFromHex("#D0D5D9"))
                    ...
                    If (e.State And DrawItemState.Selected) = DrawItemState.Selected Then
                        ...
                        Using ItemsColor As New SolidBrush(Color.FromArgb(31, 31, 31)), Itembackground As New SolidBrush(ColorFromHex("#78B7E6"))
                            G.FillRectangle(Itembackground, Rect)
                            G.DrawString(GetItemText(Items(e.Index)), New Font("Segoe UI", 9), Brushes.Black, New Point(Rect.X + 5, Rect.Y + 1))
                        End Using
